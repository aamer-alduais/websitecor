<%@ Page Language="C#" Title="Time Entry : Thermotech" MasterPageFile ="~/MasterPage.master" AutoEventWireup="true" CodeFile="time_sheet_o.aspx.cs" Inherits="time_sheet" %>
            ...
            <tr>
                ...
                <td class="style140" valign="top">
                    ...
                    <asp:SqlDataSource ID="SqlDataSourceJobNum" runat="server" 
                        ...
                        SelectCommand="SELECT DISTINCT JobNum, Plant FROM JobNums WHERE (JobNum LIKE 'NQ%') AND (Plant LIKE 'QRO') OR (JobNum LIKE 'Q%') AND (JobNum NOT LIKE 'QUF%') AND (JobNum NOT LIKE 'QF%') 

UNION ALL

Select  DISTINCT JobNum, Plant FROM JobNumsQRO
