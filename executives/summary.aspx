<%@ Page Title="Project Summary : Thermotech" Language="C#"  MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="summary.aspx.cs" Inherits="manager_summary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentHolder" Runat="Server">
           <div>
               ...
               <asp:RadioButtonList ID="RadioButtonListToolType" runat="server" AutoPostBack="True" 
                   RepeatDirection="Horizontal" CssClass="style122" 
                   ...
                   <table ID="table4" cellpadding="0" class="style147">
                       ...
                       <tr>
                           <td>
                               ...
                               &nbsp; &nbsp;&nbsp;
                               <asp:Button ID="btnProdToolsCost" runat="server" 
                                   onclick="btnProdToolsCost_Click" Text="Run Cost Report" />
                               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <br />
                               <table ID="table8" cellpadding="0" class="style127">
                                   <tr valign="top">
                                       <td class="style151">
                                           Start Date:
                                           <br />
                                           <asp:TextBox ID="TextBoxStartDateProduction" runat="server"></asp:TextBox>
                                           <cc1:CalendarExtender ID="TextBoxStartDateProduction_CalendarExtender" 
                                               runat="server" Enabled="True" TargetControlID="TextBoxStartDateProduction">
                                           </cc1:CalendarExtender>
                                           <br />
                                           <asp:RequiredFieldValidator ID="rfvStartDateProduction" runat="server" 
                                               ControlToValidate="TextBoxStartDateProduction" CssClass="style122" 
                                               Display="Dynamic" ErrorMessage="Required" 
                                               ValidationGroup="CombinedLaborProduction"></asp:RequiredFieldValidator>
                                           <asp:Label ID="LabelDateErrorProduction" runat="server" CssClass="style154"></asp:Label>
                                           <br />
                                       </td>
                                       <td class="style152">
                                           &nbsp;</td>
                                       <td class="style151">
                                           End Date:<br />
                                           <span lang="en-us">
                                           <asp:TextBox ID="TextBoxEndDateProduction" runat="server" Font-Bold="False"></asp:TextBox>
                                           <cc1:CalendarExtender ID="TextBoxEndDateProduction_CalendarExtender" 
                                               runat="server" Enabled="True" TargetControlID="TextBoxEndDateProduction">
                                           </cc1:CalendarExtender>
                                           <br />
                                           </span>
                                           <asp:RequiredFieldValidator ID="rfvEndDateProduction" runat="server" 
                                               ControlToValidate="TextBoxEndDateProduction" CssClass="style122" 
                                               Display="Dynamic" ErrorMessage="Required" 
                                               ValidationGroup="CombinedLaborProduction"></asp:RequiredFieldValidator>
                                       </td>
                                       <td>
                                           <br />
                                           <asp:Button ID="ButtonProductionCombinedSummary" runat="server" 
                                               onclick="ButtonProductionCombinedSummary_Click" Text="Combined Labor Summary" 
                                               ValidationGroup="CombinedLaborProduction" />
                                       </td>
                                   </tr>
                               </table>
                       ...
                       <tr>
                           <td ID="RevChart2" class="style155">
                               <div class="style146">
                               </div>
...
&nbsp;<br />
               <asp:GridView ID="gvProjectDetail" runat="server" AutoGenerateColumns="False" 
                   ...
                   GridLines="None" onrowdatabound="gvProjectDetail_RowDataBound">
                   <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
                   <Columns>
                       <asp:CommandField ButtonType="Button" ShowSelectButton="True" />
                       ...
                       <asp:BoundField DataField="Possible Revenue" HeaderText="Possible Revenue" 
                           SortExpression="Possible Revenue" ReadOnly="True" >
                       <HeaderStyle HorizontalAlign="Left" />
                       </asp:BoundField>
                       <asp:BoundField DataField="Revenue Todate" HeaderText="Revenue Todate" 
                           SortExpression="Revenue Todate" ReadOnly="True" />
                       <asp:BoundField DataField="Project Cost" HeaderText="Project Cost" 
                           SortExpression="Project Cost" ReadOnly="True" />
                   </Columns>
               ...
               <table ID="table6" cellpadding="0" class="style127">
                   <tr>
                       <td colspan="3">
                           &nbsp;</td>
                   </tr>
                    <tr>
                       <td colspan="3">
                           <asp:Button ID="GotoJobDetail" runat="server" onclick="GotoJobDetail_Click" Text="Job Details"/>
                           &nbsp;
                           <asp:Button ID="GotoPOInfo" runat="server" onclick="GotoPOInfo_Click" Text="PO Details"/>
                           &nbsp;
                           <strong>Quote Numbers : </strong>
                           <asp:PlaceHolder ID="QuoteLinkPlaceHolder" runat="server"></asp:PlaceHolder>
                       </td>
                   </tr>
                   <tr>
                       <td class="style158">
                          
                           <asp:Button ID="ButtonCrystalReport" runat="server" OnClick="ButtonCrystalReport_Click" Text="Display Project Report"  />
                           &nbsp;
                           <asp:Button ID="ButtonCrystalReportProjectSummary" runat="server" 
                               onclick="ButtonCrystalReportProjectSummary_Click" 
                               Text="Display Project Summary" Width="160px" />
                           <br />
                       </td>
                       <td class="style159">
                           <asp:RadioButtonList ID="RadioButtonListVarianceReportOptions" runat="server" 
                       ...
                       <td class="style150">
                           <asp:Button ID="ButtonVarianceReportRetrieve" runat="server" 
                               onclick="ButtonVarianceReportRetrieve_Click" Text="Run Variance Report" />
                       </td>
                   </tr>
               </table>
               <table ID="table7" cellpadding="0" class="style127">
                   <tr valign="top">
                       <td class="style151">
                           Start Date:
                           <br />
                           ...
                           <asp:RequiredFieldValidator ID="rfvStartDate" runat="server" 
                               ControlToValidate="TextBoxStartDate" CssClass="style122" Display="Dynamic" 
                               ErrorMessage="Required" ValidationGroup="CombinedLabor"></asp:RequiredFieldValidator>
                           <asp:Label ID="LabelDateError" runat="server" CssClass="style154"></asp:Label>
                           <br />
                       </td>
                       <td class="style152">
                           &nbsp;</td>
                       <td class="style153">
                           End Date:<br />
                           <span lang="en-us">
                           <asp:TextBox ID="TextBoxEndDate" runat="server" Font-Bold="False"></asp:TextBox>
                           <cc1:CalendarExtender ID="TextBoxEndDate_CalendarExtender" runat="server" 
                               Enabled="True" TargetControlID="TextBoxEndDate">
                           </cc1:CalendarExtender>
                           </span>
                           <asp:RequiredFieldValidator ID="rfvEndDate" runat="server" CssClass="style122" 
                               ErrorMessage="Required" ValidationGroup="CombinedLabor" 
                               ControlToValidate="TextBoxEndDate" Display="Dynamic"></asp:RequiredFieldValidator>
                       </td>
                       <td class="style156">
                           <br />
                           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                           <asp:Button ID="ButtonCombinedLabor" runat="server" 
                               onclick="ButtonCombinedLabor_Click" Text="Combined Labor Summary" 
                               ValidationGroup="CombinedLabor" />
                       </td>
                       <td>
                           &nbsp;</td>
                   </tr>
     ...
     <table class="style136">
        <tr>
            <td class="style148" id="RevChart">
        
            </td>
            <td align="center" class="style149" id="RevChart" colspan="2">
                                <asp:Label ID="LabelAlert" runat="server" BackColor="Red" Font-Bold="True" 
                                    Font-Size="Medium" ForeColor="White" style="text-align: left" 
                                    Text="Actual Hours has exceeded Estimated Hours for this Project" 
                                    Visible="False"></asp:Label>
            </td>
        </tr>
         <tr>
             <td ID="RevChart" class="style130">
                 &nbsp;
                 <div ID="RevChart1" class="style128">
                     <br />
                     <div align="center">
                         <asp:Chart ID="RevChartBar" runat="server">
                             <Legends>
                                 <asp:Legend Name="LegendMain">
                                 </asp:Legend>
                             </Legends>
                             <Series>
                                 <asp:Series Legend="LegendMain" LegendText="Total Project Revenue" 
                                     Name="BarSeriesTPR">
                                 </asp:Series>
                                 <asp:Series ChartArea="ChartArea1" Legend="LegendMain" 
                                     LegendText="Total Revenue To Date" Name="BarSeriesTRD">
                                 </asp:Series>
                                 <asp:Series ChartArea="ChartArea1" Legend="LegendMain" 
                                     LegendText="Total Project Cost" Name="BarSeriesTPC">
                                 </asp:Series>
                             </Series>
                             <ChartAreas>
             ...
             <td ID="RevChart" align="center" class="style143">
                 <div class="style144">
                     <span class="style145">Estimated Project Hours<br />
                     </span>
                     <br />
                 </div>
             ...
             <td ID="RevChart" align="center" class="style130">
                 <div class="style146">
                 ...
                 <asp:Chart ID="HoursChart" runat="server">
                     <Series>
                         <asp:Series ChartType="Pie" IsVisibleInLegend="False" 
                             LabelBorderDashStyle="Dot" LabelForeColor="White" Name="HoursSeries">
        ...
        <tr class="bottomChart">
            <td class="style130" id="RevChart">
           
               <div align="left" >
                   <img align="top" alt="" class="style125" src="../images/pieLegend.PNG" /><br />
                   <asp:Chart ID="RevChart" runat="server" BackColor="Transparent" Height="290px" 
                       Palette="None" 
                       PaletteCustomColors="Brown; Gold; CornflowerBlue; MediumPurple; PaleVioletRed; MediumSeaGreen; Tomato; LightSalmon; SandyBrown; BurlyWood; OliveDrab; Teal" 
                       Width="321px">
            ...
            <asp:ChartArea Name="ChartArea1" AlignmentOrientation="All">
                ...
                <Area3DStyle Enable3D="True" IsClustered="True" IsRightAngleAxes="False" 
                    LightStyle="Realistic" Rotation="40" WallWidth="10" />
            ...
            <Series>
                       <asp:Series Name="RevenueSeries" ChartType="Pie" Legend="MainLegend"  >
                       </asp:Series>
                   </Series>
               </asp:Chart>
               &nbsp;</div>
    ...
    ConnectionString="<%$ ConnectionStrings:EpicorSQLServer %>" 
        ...
        <FilterParameters>
            <asp:ControlParameter ControlID="TextBoxSearch" Name="ProjectID" 
               ...
               <asp:SqlDataSource ID="SDS_ProjectManagers" runat="server" 
                   ConnectionString="<%$ ConnectionStrings:EpicorSQLServer %>" 
                   
                   SelectCommand="SELECT DISTINCT RTRIM(LTRIM(Employee)) AS EmpName FROM EmpProject">
               </asp:SqlDataSource>
<br />
&nbsp;
