<%@ Page Language="C#" Title="Job Information : Thermotech" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="job_display.aspx.cs" Inherits="job_display" %>
            ...
            <tr>
                <td class="style134" valign="top">
                    <asp:HyperLink ID="HyperLinkGoBack" runat="server" CssClass="style136" 
                        NavigateUrl="~/executives/summary.aspx" style="background-color: #FFFF00">&lt;&lt; Go to Project Summary Page</asp:HyperLink>
                </td>
