<%@ Page Language="C#" Title="Time Entry : Thermotech" MasterPageFile ="~/MasterPage.master" AutoEventWireup="true" CodeFile="manual_time_sheet_salary.aspx.cs" Inherits="time_sheet" %>
...
<asp:Content ContentPlaceHolderID ="MainContentHolder"  runat="server"  id="Content1">
        ...
        <table cellpadding="0" class="mainTable">
            <tr>
                ...
                <td class="style138" valign="top" colspan="2">
                    <strong>Manual Time Entry for Salaried Employees</strong><br />
          ...
          <asp:ListItem Text ="--SELECT--" Value="" ></asp:ListItem>
            ...
            <tr>
                ...
                <td class="style140" valign="top">
                    <asp:DropDownList ID="DropDownListJobNumber" runat="server" AutoPostBack="True" 
                        DataSourceID="SqlDataSourceJobNum" DataTextField="Jobs" 
                        DataValueField="Jobnum" 
                        onselectedindexchanged="DropDownListJobNumber_SelectedIndexChanged" 
                        AppendDataBoundItems ="True" CausesValidation="True" BackColor="#5A799C" 
                    ...
                    <asp:SqlDataSource ID="SqlDataSourceJobNum" runat="server" 
                        ...
                        SelectCommand="SELECT DISTINCT REPLACE(Jobnum, 'T', '') + ' Prod HOP' AS Jobs, Jobnum FROM JobNums AS JobNums WHERE (Jobnum LIKE 'T%') UNION SELECT DISTINCT REPLACE(Jobnum, 'N', '') + ' New Tool Hopkins' AS Jobs, Jobnum FROM JobNums AS JobNums WHERE (Jobnum LIKE 'N%') AND (Jobnum NOT LIKE 'NJ%') AND (Jobnum NOT LIKE 'NQ%') AND (Jobnum NOT LIKE 'NCF%')AND (Jobnum NOT LIKE 'NEX%')UNION SELECT DISTINCT JobNum AS Jobs, Jobnum FROM JobNums AS JobNums WHERE (Jobnum LIKE 'Nex%') UNION SELECT DISTINCT REPLACE(Jobnum, 'NQ', '') + ' New Tool QRO' AS Jobs, Jobnum FROM JobNums AS JobNums WHERE (Jobnum LIKE 'NQ%') UNION SELECT DISTINCT REPLACE(Jobnum, 'Q', '') + ' Prod QRO' AS Jobs, Jobnum FROM JobNums AS JobNums WHERE (Jobnum LIKE 'Q%') AND JobNum NOT LIKE 'QUF%' AND JobNum NOT LIKE 'QF%' AND JobNum NOT LIKE 'QMF%'  UNION SELECT DISTINCT REPLACE(Jobnum, 'NJ', '') + ' New Tool JRZ' AS Jobs, Jobnum FROM JobNums AS JobNums WHERE (Jobnum LIKE 'NJ%')UNION SELECT DISTINCT REPLACE(Jobnum, 'J', '') + ' Prod JRZ' AS Jobs, Jobnum FROM JobNums AS JobNums WHERE (Jobnum LIKE 'J%') AND JobNum NOT LIKE 'JUF%' AND JobNum NOT LIKE 'JF%' UNION SELECT DISTINCT REPLACE(Jobnum, 'NCF', '') + ' CF' AS Jobs, Jobnum FROM JobNums AS JobNums WHERE (Jobnum LIKE '%NCF%') ORDER BY Jobs DESC"></asp:SqlDataSource>
            ...
            <tr>
                <td class="style113">
                    &nbsp;</td>
                <td class="style2" valign="top">
                    <span lang="en-us"><strong>Job Description</strong></span></td>
                <td class="style140">
            ...
            <tr>
                ...
                <td class="style4" valign="top">
                    <span lang="en-us"><strong>Task Type</strong></span></td>
                <td class="style8">
            ...
            <tr>
                <td class="style113">
                    &nbsp;</td>
                <td class="style2" valign="top">
                    <span lang="en-us"><strong>Duration</strong></span></td>
                <td class="style140">
            ...
            <tr>
                <td class="style113">
                    &nbsp;</td>
                <td class="style2" valign="top">
                    <span lang="en-us"><strong>Comments</strong></span></td>
                <td class="style140">
    ...
    <asp:ScriptManager ID="AJAXScriptManager" runat="server">
        ...
        ConnectionString="<%$ ConnectionStrings:EpicorSQLServer %>" 
            ...
            SelectCommand="SELECT DISTINCT UserID AS EmpID, CAST(UserID AS varchar) + ': ' + FName + ' ' + LName AS EmpIDName, FName FROM Users WHERE (UserID &lt;&gt; '0') AND (UserID &lt;&gt; '1111') AND (UserID &lt;&gt; '1112') AND (UserID &lt;&gt; '1113') AND (Plant = 'HOP') ORDER BY FName"></asp:SqlDataSource>
                    <asp:HiddenField ID="HiddenUserRole" runat="server" />
                    <asp:HiddenField ID="HiddenUserRoleID" runat="server" />
                    </asp:Content>